...
export default async function Home() {
  const data = await fetch("https://www.dolarsi.com/api/api.php?type=valoresprincipales").then(
    (res) => res.json() as Promise<{casa: {nombre: string; compra: string; venta: string}}[]>,
    );
